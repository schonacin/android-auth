...
public class BaseDefragmentationProviderTest {
    ...
    public void transformsMultipleFragmentsOutOffOrderWithoutWraparoundWithNoErrors() throws BleException {
        ...
        defragmentationProvider.defragment(Flowable.just(TEST_MULTIPLE_FRAGMENTS_INIT_FRAG, TEST_MULTIPLE_FRAGMENTS_CONT_FRAG_0, TEST_MULTIPLE_FRAGMENTS_CONT_FRAG_1, TEST_MULTIPLE_FRAGMENTS_CONT_FRAG_2), TEST_MULTIPLE_FRAGMENTS_MAXLEN).test().assertNoErrors();
    }
    ...
    public void transformsMoreDataThanSpecifiedInHeaderWithErrors() throws BleException {
        ...
        defragmentationProvider.defragment(Flowable.just(TEST_MORE_DATA_THAN_SPECIFIED_INIT_FRAG, TEST_MORE_DATA_THAN_SPECIFIED_CONT_FRAG), TEST_MORE_DATA_THAN_SPECIFIED_MAXLEN).test().assertNoErrors();
    }
